...
export const NewsItems: NewsItem[] = [
  {
    ...
    items: [
      ...
      { text: <>Enterprise-grade AI workspace with professional features</> },
...
const _archivedNewsItems: NewsItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: <>1.16.3: Support for <B href='https://www.anthropic.com/news/claude-3-5-sonnet'>Anthropic 3.5 Sonnet</B> (refresh your <B>Anthropic</B> models)</> },
      { text: <>1.16.4: <B>8192 tokens</B> support for Anthropic 3.5 Sonnet</> },
  ...
  },
  {
    ...
    items: [
      { text: <>Anthropic <B href='https://www.anthropic.com/news/claude-3-family'>AI Models</B> support for smarter chats</>, issue: 443, icon: AnthropicIcon },
  ...
  },
  {
    ...
    items: [
      ...
      { text: <><Link href='https://abov3.com'>Website</Link>: official downloads</> },
  ...
  },
  {
    ...
    items: [
      ...
      { text: <>Added support for Anthropic models</> },
