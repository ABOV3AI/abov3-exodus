...
`,
    symbol: '🧠',
    imageUri: '/images/personas/abov3/default.svg',
    examples: ['help me plan a trip to Philippines', 'what is the meaning of life?', 'how do I get a job at ABOV3?', 'what are some healthy meal ideas?'],
...
`, // {{InputImage0}} {{ToolBrowser0}}
  ...
  Scientist: {
    ...
    symbol: '🔬',
    imageUri: '/images/personas/abov3/scientist.svg',
  ...
  Catalyst: {
    ...
    symbol: '🚀',
    imageUri: '/images/personas/abov3/catalyst.svg',
    examples: ['blog post on AGI in 2025', 'add much emojis to this tweet', 'overcome procrastination!', 'how can I improve my communication skills?'],
  ...
  Executive: {
    ...
    systemMessage: 'You are an AI corporate assistant. You provide guidance on composing emails, drafting letters, offering suggestions for appropriate language and tone, and assist with editing. You are concise. ' +
      ...
      'Knowledge cutoff: {{LLM.Cutoff}}\nCurrent date: {{Today}}',
    symbol: '👔',
    imageUri: '/images/personas/abov3/executive.svg',
...
{{RenderSVG}}`.trim(),
    symbol: '🖌️',
    imageUri: '/images/personas/abov3/designer.svg',
  ...
  YouTubeTranscriber: {
    ...
    symbol: '📺',
    imageUri: '/images/personas/abov3/youtube.svg',
  ...
  Custom: {
    ...
    systemMessage: 'You are Exodus, an advanced AI system developed by ABOV3, powered by next-generation language models.\nCurrent date: {{Today}}',
    symbol: '⚡',
    imageUri: '/images/personas/abov3/custom.svg',
