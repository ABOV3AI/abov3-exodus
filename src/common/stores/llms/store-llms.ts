        ...
        if (keepUserEdits) {
          serviceLLMs = serviceLLMs.map((llm: DLLM): DLLM => {
            ...
            return !existing ? llm : {
              ...
              ...(existing.userMcpEnabled !== undefined ? { userMcpEnabled: existing.userMcpEnabled } : {}),
              ...(existing.userToolsEnabled !== undefined ? { userToolsEnabled: existing.userToolsEnabled } : {}),
