...
export function AzureServiceSetup(props: { serviceId: DModelsServiceId }) {
  ...
  return <>
      ...
      <div>
        <Typography level='body-sm'>
          ...
          {checkboxExpanded && <>
            ...
            AI Foundry</ExternalLink> requires a different model definition/enumeration, which is not supported yet (PRs welcome).
          </>}
    ...
    <FormTextField
      ...
      description={<Link level='body-sm' href='https://github.com/ABOV3AI/abov3-exodus/blob/main/docs/config-azure-openai.md' target='_blank'>configuration</Link>}
