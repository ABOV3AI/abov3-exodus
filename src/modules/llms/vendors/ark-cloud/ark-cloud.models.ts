...
import { LLM_IF_OAI_Chat, LLM_IF_OAI_Fn, LLM_IF_OAI_Reasoning, LLM_IF_OAI_Vision, LLM_IF_Tools_WebSearch } from '~/common/stores/llms/llms.types';
...
export const arkCloudModels: ModelDescriptionSchema[] = [
...

  {
    ...
    interfaces: [LLM_IF_OAI_Chat, LLM_IF_OAI_Fn, LLM_IF_OAI_Reasoning, LLM_IF_Tools_WebSearch],
  ...
  },
  {
    ...
    description: 'Workhorse — vision + coding specialist with tools',
    contextWindow: 128000,
    maxCompletionTokens: 16384,
    interfaces: [LLM_IF_OAI_Chat, LLM_IF_OAI_Fn, LLM_IF_OAI_Reasoning, LLM_IF_OAI_Vision, LLM_IF_Tools_WebSearch],  // qwen3.5 supports vision natively
    chatPrice: { input: 'free', output: 'free' },
    defaultUserToolsEnabled: true,  // Enable MCP/tools by default for ABOV3 models
  },
  {
  ...
  },
  {
    ...
    interfaces: [LLM_IF_OAI_Chat, LLM_IF_OAI_Fn, LLM_IF_Tools_WebSearch],
    chatPrice: { input: 'free', output: 'free' },
    defaultUserToolsEnabled: true,  // Enable MCP/tools by default for ABOV3 models
  },
