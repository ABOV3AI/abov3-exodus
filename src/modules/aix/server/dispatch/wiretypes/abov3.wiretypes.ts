 ...
 *
 */
export namespace ABOV3Wire_Blocks {
  ...
  export function ToolUseBlock(id: string, name: string, input: string | null): z.infer<typeof ToolUseBlock_schema> {
    // ABOV3 Tool Invocations want the input as object, and will reject 'null' inputs for instance.
    // - ".input: Input should be a valid dictionary" - ABOV3
    // - ".input: Field required" - ABOV3
    // -> we replace 'null' and '', with {}
    return { type: 'tool_use', id, name, input: !input ? {} : JSON.parse(input) /* 2024-11-03: ABOV3 requires an object in 'input' */ };
  }
...
export namespace ABOV3Wire_Messages {
  /**
  ...
  const _ContentBlockInput_schema = z.discriminatedUnion('type', [
    ...
    ABOV3Wire_Blocks.TextBlock_schema,
    ABOV3Wire_Blocks.ThinkingBlock_schema,
    ABOV3Wire_Blocks.RedactedThinkingBlock_schema,
    ABOV3Wire_Blocks.ToolUseBlock_schema,
    // Input-Only Blocks
    ABOV3Wire_Blocks.ImageBlock_I_schema,
    ABOV3Wire_Blocks.DocumentBlock_I_schema,
    ABOV3Wire_Blocks.SearchResultBlock_I_schema,
    ABOV3Wire_Blocks.ToolResultBlock_I_schema,
    // Server Tool Blocks (originates from output -> copied to input)
    ABOV3Wire_Blocks.ServerToolUseBlock_schema,
    ABOV3Wire_Blocks.WebSearchToolResultBlock_schema,
    ABOV3Wire_Blocks.WebFetchToolResultBlock_schema,
    ABOV3Wire_Blocks.CodeExecutionToolResultBlock_schema,
    ABOV3Wire_Blocks.BashCodeExecutionToolResultBlock_schema,
    ABOV3Wire_Blocks.TextEditorCodeExecutionToolResultBlock_schema,
    ABOV3Wire_Blocks.MCPToolUseBlock_schema,
    ABOV3Wire_Blocks.MCPToolResultBlock_schema,
    ABOV3Wire_Blocks.ContainerUploadBlock_schema,
  ]);
...
export namespace ABOV3Wire_Tools {
  ...
  const _ToolDefinitionBase_schema = z.object({
    ...
    cache_control: ABOV3Wire_Blocks._CacheControl_schema.nullish(),
  });
...
// Messages > Create
//
export namespace ABOV3Wire_API_Message_Create {
  ...
  export const Request_schema = z.object({
     ...
     */
    system: z.array(ABOV3Wire_Blocks.TextBlock_schema).optional(), // NOTE: we force ourselves to always write the array representation
    // system: z.union([z.string(), z.array(ABOV3Wire_Blocks.TextBlock_schema)]).optional(),
     ...
     */
    messages: z.array(ABOV3Wire_Messages.MessageInput_schema),
     ...
     */
    tools: z.array(ABOV3Wire_Tools.ToolDefinition_schema).optional(),
  ...
  export const Response_schema = z.object({
     ...
     */
    content: z.array(ABOV3Wire_Messages.ContentBlockOutput_schema),
  ...
  export const event_ContentBlockStart_schema = z.object({
    ...
    index: z.number(),
    content_block: ABOV3Wire_Messages.ContentBlockOutput_schema,
  });
